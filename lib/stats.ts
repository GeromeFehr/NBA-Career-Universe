...
export function summarizeCareerMarks(rows:StatRow[]){
  ...
  return {
    ...
    games20Rebounds:count(r=>Number(r.rebounds||0)>=20),
    games15Assists:count(r=>Number(r.assists||0)>=15),
    games5Blocks:count(r=>Number(r.blocks||0)>=5),
    games5Steals:count(r=>Number(r.steals||0)>=5),
